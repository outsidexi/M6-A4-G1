...
from primera_aplicacion.forms.formularioproveedor import FormularioSupplierForm
...
class SupplierApp(TemplateView):
...
class FormSuppliers(TemplateView):
    ...
    def post(self, request,**kwargs):
        ...
        if form.is_valid():
            ...
            datos = DatosProveedor(id=supplier_name, direccion=direccion, area=area, producto=producto)
            datos.save()
        else:
            print("Formulario Invalido")
            print(form)
